...
# 使用示例
input_jsonl = '/data/home/weijh/zyh/emnlp/BM/ours/result/180output.jsonl'  # 替换为你的输入文件路径
output_excel = '/data/home/weijh/zyh/emnlp/BM/ours/result/180.xlsx'  # 替换为你想要的输出文件路径
