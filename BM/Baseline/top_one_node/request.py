...
if __name__ == "__main__":
    ...
    args.add_argument("--save_path", type=str, default="/data/home/weijh/zyh/emnlp/BM/Baseline/top_one_node/result/ouput.jsonl",
                        help="Directory to save the results.")
    args.add_argument("--max_batch_size", default=20, type=int,
                        help="max Batch size for request")
    args.add_argument("--Medusa_choice", default="Topone", type=str,
