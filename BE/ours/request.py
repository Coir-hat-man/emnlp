...
class RequestProcessor:
    ...
    def eval(self):#对延迟和吞吐进行测评
        ...
        output ={"batch_size":self.args.max_batch_size,"request_speed":self.args.Request_speed,"Node_num":self.args.Node_num,"average_latency":all_latency/len(self.completed_stack),"throughput":all_count/(self.end_time-self.start_time),"Accept_ratio":accept_ratio/len(self.completed_stack),"TPOT_ratio":float(count/len(self.completed_stack)),"TPOT_list":TPOT_list}
        print(output)
...
if __name__ == "__main__":
    ...
    args.add_argument("--save_path", type=str, default="/data/home/weijh/zyh/emnlp/BE/ours/result/60output.jsonl",
    ...
    args.add_argument("--Node_num",default=60,type=int)
    args.add_argument("--All_request_num", default=30, type=int)
    ...
    Eagle = Parallel_decoding(args.base_model_path, args.EAGLE_model_path, args.Node_num, Device_index=device_index)
