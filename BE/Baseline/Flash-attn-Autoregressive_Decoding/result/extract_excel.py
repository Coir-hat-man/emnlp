...
# 使用示例
input_jsonl = '/data/home/weijh/zyh/emnlp/BE/Baseline/Flash-attn-Autoregressive_Decoding/result/output.jsonl'  # 替换为你的输入文件路径
output_excel = '/data/home/weijh/zyh/emnlp/BE/Baseline/Flash-attn-Autoregressive_Decoding/result/output.xlsx'  # 替换为你想要的输出文件路径
